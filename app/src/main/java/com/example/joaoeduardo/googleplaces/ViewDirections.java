...
import com.example.joaoeduardo.googleplaces.Helper.DirectionJSONParser;
...
public class ViewDirections extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void drawPath(Location mLastLocation, com.example.joaoeduardo.googleplaces.Model.Location location) {
        //Clear all Polyline
        if (polyline!=null)
            polyline.remove();
